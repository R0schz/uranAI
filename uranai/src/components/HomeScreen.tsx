    ...
    <section className="page p-4">
      <div className="page-content max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div data-action="select-purpose" data-purpose="personal" className="card p-8 text-center cursor-pointer hover:border-purple-400 transition">
            ...
            <p className="text-gray-400">あなた自身を<br />深く占います</p>
          </div>
          <div data-action="select-purpose" data-purpose="compatibility" className="card p-8 text-center cursor-pointer hover:border-cyan-400 transition">
            ...
            <p className="text-gray-400">特定の人との相性を<br />占います</p>
          </div>
        </div>
      </div>
    </section>
